...
RUN apk add --update protobuf=3.21.9-r0 protobuf-dev=3.21.9-r0 gcc=12.2.1_git20220924-r4 libc-dev=0.7.2-r3
RUN rm -rf /var/cashe/apk/*
RUN go install github.com/golangci/golangci-lint/cmd/golangci-lint@v1.51.1
RUN go install github.com/go-task/task/v3/cmd/task@v3.20.0
